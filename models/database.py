...
def create_tables():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS student (id SERIAL PRIMARY KEY, name text, last_module VARCHAR(255), links_preferred integer, stats_preferred integer, links_counter integer, language VARCHAR(255))")
